...
$language['InstanceNotStop'] = 'Comportament aturar màquina automàtic';
$language['not_auto_stop'] = 'No auto aturar';
$language['allow_auto_stop'] = 'Permetre auto aturar';
$language['Segur que vol permetre que no apagui'] = 'Segur que vol permetre que no aturar';
$language['Segur que vol permetre que apagui'] = 'Segur que vol permetre que aturar';
$language['Behauviour of instance is stop automatically'] = 'Comportament apagat automàtic d\'instància %s a sí';
$language['Behauviour of instance is not stop automatically'] = 'Comportament apagat automàtic d\'instància %s a no';
$language['List instances'] = 'Llistar intàncies';