...
You can add a custom parameter allowing you to explicitly sets the region for the service to use. The custom parameter is **amazon_region** and possibles values are (you can find updated values from [here] http://docs.aws.amazon.com/general/latest/gr/rande.html#ec2_region):
